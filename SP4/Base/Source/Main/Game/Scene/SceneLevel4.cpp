...
void SceneLevel4::UpdateCharacterLogic(double dt)
{
}

void SceneLevel4::UpdateInternals(double dt)
{
}

bool SceneLevel4::CheckCollision(BaseObject* o1, BaseObject* o2, std::string type)
{
	if (type == "Circle")
	{
		// Simple BC.
...
void SceneLevel4::Update(float dt)
{
...
void SceneLevel4::RenderObjects(BaseObject *obj)
{
...
void SceneLevel4::HandleUserInput()
{
	//Keys Section
	//Mouse Section
...
void SceneLevel4::SpawnWave(int Currentwave)
{
	if (Currentwave > Waves)
	{
